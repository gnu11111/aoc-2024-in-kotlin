...
class Day05Test {
    ...
    private val pages = listOf("75,47,61,53,29", "97,61,53,29,13", "75,29,13", "75,97,47,61,53", "61,13,29",
        "97,13,75,29,47")
    ...
    fun testMySolution() {
        ...
        for (function in test.keys) {
            ...
            println("Day05::${function.name}: ${rules.size} rules, ${pages.size} pages -> $result [$time]")
